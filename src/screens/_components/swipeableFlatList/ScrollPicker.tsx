...
export default function ScrollPicker({
  ...
  const styles = StyleSheet.create({
    ...
    itemTextSelected: {
      color: props.HighlightfontColor,
      fontWeight: "bold",
      fontFamily: "Circular Std",
      fontSize: props.HighlightfontSize,
    },
  });
  ...
  const wrapperStyle: ViewStyle = {
    ...
    width: props.wrapperWidth ? props.wrapperWidth : deviceWidth - 0,
    backgroundColor: props.wrapperColor || "#fafafa",
    overflow: "hidden",
    borderRadius: 0,
  };
  const wrapperStyleMain = props.backgroundStyle
    ? props.backgroundStyle
    : wrapperStyle;

  const highlightStyle: ViewStyle = {
    position: "absolute",
    backgroundColor: props.HighlightColour ? props.HighlightColour : "gray",
    borderRadius: itemHeight / 10,
    top: (wrapperHeight - itemHeight) / 2,
    height: itemHeight,
    width: props.wrapperWidth
      ? props.wrapperWidth - props.wrapperWidth / 3
      : deviceWidth - 20,
    left: props?.wrapperWidth? props.wrapperWidth / 6 : 10,
  ...
  return (
    <View style={props.backgroundStyle ? props.backgroundStyle : wrapperStyle}>
      <View
        style={props.HighlightStyle ? props.HighlightStyle : highlightStyle}
      />
